...
type DataPopupContent = string | HTMLElement | Text | ((feature: DataFeature) => string | HTMLElement | Text);
type DataPopupValue = DataPopupContent | PopupOptions | Popup;
