...
Popups, tooltips and InfoWindows are separate because importing one of them adds methods to other
objects — `attachPopup()` on a marker, for example. A bundler can't tell whether you're going to
